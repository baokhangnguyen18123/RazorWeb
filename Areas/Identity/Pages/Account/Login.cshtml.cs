...
namespace App.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// 
            // [EmailAddress]
            [Required(ErrorMessage ="Phải nhập Email hoặc tên tài khoản")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Tìm User theo User name -> login lại
                if (!result.Succeeded)
                {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Đăng nhập thất bại, kiểm tra lại tài khoản và mật khẩu!");
                    return Page();
                }
            }
